  ...
  return (
    <>
      ...
      <section className="px-6 xl:px-8 pb-8 flex flex-wrap gap-4">
        <Card title="TrailPredict">
          <h3 className="italic font-bold text-sm">
            Le chrono avant les courbatures
          </h3>
          <p>
            Bienvenue sur TrailPredict,
            <br />
            L'application qui analyse vos performances de trail pour prédire
            votre prochain temps de course.💪
            <br />
            Découvrez des estimations personnalisées pour mieux préparer vos
            objectifs.🚀
            <br />
            Pour profiter du service et accéder à vos prédictions, veuillez vous
            connecter.
          </p>
          <button
            onClick={log}
            className="border border-primary rounded-lg flex items-center p-4 gap-4 cursor-pointer hover:bg-gray-50"
          >
            <svg
