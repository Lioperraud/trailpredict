function InfoIcoText({ Ico, titre, sousTitre, chiffre }) {
  return (
    <div className="h-full flex flex-col items-center justify-center gap-4 p-4 text-secondary">
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <h4 className="text-sm font-bold text-primary">{sousTitre}</h4>
        <h2 className="text-6xl font-bold border-t border-primary px-8 pt-2">
          {chiffre}
        </h2>
      </div>
    </div>
